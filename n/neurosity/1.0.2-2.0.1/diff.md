# Comparing `tmp/neurosity-1.0.2.tar.gz` & `tmp/neurosity-2.0.1.tar.gz`
...
### Comparing `neurosity-1.0.2/README.md` & `neurosity-2.0.1/PKG-INFO`
...
### Comparing `neurosity-1.0.2/setup.py` & `neurosity-2.0.1/setup.py`
