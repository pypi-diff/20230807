# Comparing `tmp/mygrader-0.1.3.tar.gz` & `tmp/mygrader-0.1.4.tar.gz`
...
## Comparing `mygrader-0.1.3.tar` & `mygrader-0.1.4.tar`
...
### Comparing `mygrader-0.1.3/LICENSE` & `mygrader-0.1.4/LICENSE`

 * *Files identical despite different names*

### Comparing `mygrader-0.1.3/README.md` & `mygrader-0.1.4/README.md`
