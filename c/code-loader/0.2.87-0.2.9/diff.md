# Comparing `tmp/code_loader-0.2.87.tar.gz` & `tmp/code-loader-0.2.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "code_loader-0.2.87.tar", max compression
+gzip compressed data, was "code-loader-0.2.9.tar", max compression
```

## Comparing `code_loader-0.2.87.tar` & `code-loader-0.2.9.tar`

### file list

```diff
@@ -1,34 +1,17 @@
--rw-r--r--   0        0        0     1067 2022-04-07 12:50:20.120430 code_loader-0.2.87/LICENSE
--rw-r--r--   0        0        0       63 2022-04-07 12:50:20.120719 code_loader-0.2.87/README.md
--rw-r--r--   0        0        0      116 2022-05-21 15:07:10.288229 code_loader-0.2.87/code_loader/__init__.py
--rw-r--r--   0        0        0        0 2022-04-07 12:50:20.121028 code_loader-0.2.87/code_loader/contract/__init__.py
--rw-r--r--   0        0        0     4268 2023-04-02 14:31:34.761183 code_loader-0.2.87/code_loader/contract/datasetclasses.py
--rw-r--r--   0        0        0     1481 2023-02-16 08:00:56.984630 code_loader-0.2.87/code_loader/contract/enums.py
--rw-r--r--   0        0        0       51 2023-02-02 10:36:34.112141 code_loader-0.2.87/code_loader/contract/exceptions.py
--rw-r--r--   0        0        0     2577 2023-04-13 15:08:14.905478 code_loader-0.2.87/code_loader/contract/responsedataclasses.py
--rw-r--r--   0        0        0     4761 2022-08-24 13:07:10.256551 code_loader-0.2.87/code_loader/contract/visualizer_classes.py
--rw-r--r--   0        0        0        0 2023-02-05 16:04:15.456410 code_loader-0.2.87/code_loader/helpers/__init__.py
--rw-r--r--   0        0        0        0 2023-02-05 16:04:15.456582 code_loader-0.2.87/code_loader/helpers/detection/__init__.py
--rw-r--r--   0        0        0     7527 2023-02-05 16:04:15.457141 code_loader-0.2.87/code_loader/helpers/detection/utils.py
--rw-r--r--   0        0        0        0 2023-02-05 16:04:15.457285 code_loader-0.2.87/code_loader/helpers/detection/yolo/__init__.py
--rw-r--r--   0        0        0     7905 2023-08-06 11:16:35.860623 code_loader-0.2.87/code_loader/helpers/detection/yolo/decoder.py
--rw-r--r--   0        0        0       81 2023-06-13 17:52:07.030956 code_loader-0.2.87/code_loader/helpers/detection/yolo/enums.py
--rw-r--r--   0        0        0     3132 2023-02-05 16:04:15.458225 code_loader-0.2.87/code_loader/helpers/detection/yolo/grid.py
--rw-r--r--   0        0        0    18610 2023-08-06 11:16:35.861058 code_loader-0.2.87/code_loader/helpers/detection/yolo/loss.py
--rw-r--r--   0        0        0    11349 2023-06-13 17:52:07.032041 code_loader-0.2.87/code_loader/helpers/detection/yolo/pytorch_utils.py
--rw-r--r--   0        0        0     8037 2023-08-06 11:16:35.861457 code_loader-0.2.87/code_loader/helpers/detection/yolo/utils.py
--rw-r--r--   0        0        0        0 2023-06-12 08:03:06.251807 code_loader-0.2.87/code_loader/helpers/instancesegmentation/__init__.py
--rw-r--r--   0        0        0      930 2023-06-12 08:03:06.252714 code_loader-0.2.87/code_loader/helpers/instancesegmentation/utils.py
--rw-r--r--   0        0        0       93 2022-05-21 15:07:10.289296 code_loader-0.2.87/code_loader/leap_binder/__init__.py
--rw-r--r--   0        0        0     6692 2023-04-02 14:31:34.763186 code_loader-0.2.87/code_loader/leap_binder/leapbinder.py
--rw-r--r--   0        0        0     4758 2023-08-06 11:16:35.861734 code_loader-0.2.87/code_loader/leap_loader_parallelized_base.py
--rw-r--r--   0        0        0    15370 2023-08-06 11:16:35.862130 code_loader-0.2.87/code_loader/leaploader.py
--rw-r--r--   0        0        0     2233 2023-08-06 11:16:35.862410 code_loader-0.2.87/code_loader/metric_calculator_parallelized.py
--rw-r--r--   0        0        0        0 2023-02-16 08:00:56.990381 code_loader-0.2.87/code_loader/metrics/__init__.py
--rw-r--r--   0        0        0     6727 2023-04-02 14:31:34.764139 code_loader-0.2.87/code_loader/metrics/default_metrics.py
--rw-r--r--   0        0        0     2376 2023-08-06 11:16:35.864599 code_loader-0.2.87/code_loader/samples_generator_parallelized.py
--rw-r--r--   0        0        0     1736 2022-05-21 15:07:10.290081 code_loader-0.2.87/code_loader/utils.py
--rw-r--r--   0        0        0        0 2022-05-21 15:07:10.290224 code_loader-0.2.87/code_loader/visualizers/__init__.py
--rw-r--r--   0        0        0     2226 2022-08-24 13:07:10.256922 code_loader-0.2.87/code_loader/visualizers/default_visualizers.py
--rw-r--r--   0        0        0      908 2023-08-06 13:57:46.170078 code_loader-0.2.87/pyproject.toml
--rw-r--r--   0        0        0      950 1970-01-01 00:00:00.000000 code_loader-0.2.87/PKG-INFO
...
### Comparing `code_loader-0.2.87/LICENSE` & `code-loader-0.2.9/LICENSE`

 * *Files identical despite different names*

### Comparing `code_loader-0.2.87/code_loader/contract/enums.py` & `code-loader-0.2.9/code_loader/contract/enums.py`
...
### Comparing `code_loader-0.2.87/code_loader/contract/responsedataclasses.py` & `code-loader-0.2.9/code_loader/contract/responsedataclasses.py`
...
### Comparing `code_loader-0.2.87/code_loader/utils.py` & `code-loader-0.2.9/code_loader/utils.py`
...
### Comparing `code_loader-0.2.87/pyproject.toml` & `code-loader-0.2.9/pyproject.toml`
...
### Comparing `code_loader-0.2.87/PKG-INFO` & `code-loader-0.2.9/PKG-INFO`
