# Comparing `tmp/ofscraper-3.0.3.tar.gz` & `tmp/ofscraper-3.0.4.tar.gz`
...
### Comparing `ofscraper-3.0.3/ofscraper/utils/auth.py` & `ofscraper-3.0.4/ofscraper/utils/auth.py`
