# Comparing `tmp/ofscraper-3.0.tar.gz` & `tmp/ofscraper-3.0.1.tar.gz`
...
### Comparing `ofscraper-3.0/ofscraper/utils/binaries.py` & `ofscraper-3.0.1/ofscraper/utils/binaries.py`
