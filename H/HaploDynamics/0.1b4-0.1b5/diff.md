# Comparing `tmp/HaploDynamics-0.1b4.tar.gz` & `tmp/HaploDynamics-0.1b5.tar.gz`
...
## Comparing `HaploDynamics-0.1b4.tar` & `HaploDynamics-0.1b5.tar`
...
### Comparing `HaploDynamics-0.1b4/HaploDynamics.egg-info/PKG-INFO` & `HaploDynamics-0.1b5/HaploDynamics.egg-info/PKG-INFO`
...
### Comparing `HaploDynamics-0.1b4/LICENSE` & `HaploDynamics-0.1b5/LICENSE`

 * *Files identical despite different names*

### Comparing `HaploDynamics-0.1b4/PKG-INFO` & `HaploDynamics-0.1b5/PKG-INFO`
...
### Comparing `HaploDynamics-0.1b4/README.md` & `HaploDynamics-0.1b5/README.md`

 * *Files identical despite different names*

### Comparing `HaploDynamics-0.1b4/setup.py` & `HaploDynamics-0.1b5/setup.py`
