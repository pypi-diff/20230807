# Comparing `tmp/HaploDynamics-0.1b6.tar.gz` & `tmp/HaploDynamics-0.1b7.tar.gz`
...
## Comparing `HaploDynamics-0.1b6.tar` & `HaploDynamics-0.1b7.tar`
...
### Comparing `HaploDynamics-0.1b6/HaploDynamics.egg-info/PKG-INFO` & `HaploDynamics-0.1b7/HaploDynamics.egg-info/PKG-INFO`
...
### Comparing `HaploDynamics-0.1b6/LICENSE` & `HaploDynamics-0.1b7/LICENSE`

 * *Files identical despite different names*

### Comparing `HaploDynamics-0.1b6/PKG-INFO` & `HaploDynamics-0.1b7/PKG-INFO`
...
### Comparing `HaploDynamics-0.1b6/README.md` & `HaploDynamics-0.1b7/README.md`

 * *Files identical despite different names*

### Comparing `HaploDynamics-0.1b6/setup.py` & `HaploDynamics-0.1b7/setup.py`
